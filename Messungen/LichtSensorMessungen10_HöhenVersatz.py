...
# Globale Variablen
filename = "lightsensor_average_data4.csv"  # CSV-Dateiname
...
def main():
    ...
    total_series = 10  # Maximale Anzahl an Serien (Abbruchbedingung)

    while measurement_number <= total_series:  # Abbruch nach 10 Serien
    ...
    print("Maximale Anzahl an Serien erreicht. Programm wird beendet.")
